  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      ...
      children: [
        ...
        Scaffold(
          backgroundColor:
              appCubit.get(context).isDark ? Colors.transparent : Color.fromARGB(255, 251, 228, 189),
          appBar: AppBar(
            centerTitle: true,
            title: Text(
            ...
            iconTheme: IconThemeData(color: appCubit.get(context).isDark
                ? Colors.white
                : Colors.black,),
            elevation: 0,
          ),
                        ...
                        child: InkWell(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                                ...
                                fontSize:
                                    appCubit.get(context).IsArabic ? 30 : 20,
                                fontFamily: 'Amiri',
                                fontWeight: FontWeight.bold),
                          ),
                        ),
